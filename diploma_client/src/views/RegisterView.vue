    ...
    <div class="flex-grow container mx-auto px-4 py-8">
      <div class="max-w-md mx-auto bg-background-two rounded-lg shadow-lg p-8">
        ...
        <form @submit.prevent="register" class="space-y-6">
          ...
          <div class="mb-4">
            <label class="block text-sm font-medium text-font-main">Электронная почта</label>
            <input v-model="email" type="email" class="mt-1 block w-full px-4 py-2 bg-background-three border border-font-main rounded-lg text-font-main focus:outline-none focus:ring-2 focus:ring-button-main" required />
          </div>
          <div class="mb-4">
