...
from apps.dictionary.views import DictionaryViewSet, FavoriteWordViewSet, CategoryViewSet, \
    PartOfSpeechViewSet
from apps.language.views import LanguageListView
from apps.library.views import LibraryViewSet, FavoriteBookViewSet
from apps.user.views import RegisterView, LanguageUpdateView, LanguageRetrieveView
...
urlpatterns = [
    ...
    path('api/checklanguage/', LanguageRetrieveView.as_view(), name='user-language'),
